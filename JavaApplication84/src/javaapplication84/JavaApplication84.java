...
public class JavaApplication84 {
    ...
    public static void main(String[] args) {
        ...
        Cadena cadenafrase = new Cadena("Matias");
        CadenaService servicio = new CadenaService();

        servicio.mostrarVocales(cadenafrase);
        servicio.invertirFrase(cadenafrase);
        int repetidas = servicio.vecesRepetidas(cadenafrase);

        System.out.println("La cantidad de veces repetidas es: " + repetidas);
        servicio.unirFrases(cadenafrase);
        servicio.compararLongitud(cadenafrase);
        servicio.reemplazar(cadenafrase);
        System.out.println(servicio.contiene(cadenafrase));
    }
}