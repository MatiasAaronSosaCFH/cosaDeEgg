...
public class Biblioteca {
    ...
    private HashSet<Libro> ejemplares = new HashSet();
    private HashSet<Libro> ejemplaresPrestados = new HashSet();
    private int ejemplaresEnPosesion = ejemplares.size();
    private int ejemplaresQueSePrestaron = ejemplaresPrestados.size();
    
    
    public void mostrarCantidad(){
        
        System.out.println("Los ejemplares en posesion son: ");
        System.out.println(ejemplaresEnPosesion = ejemplares.size());
    }
}
